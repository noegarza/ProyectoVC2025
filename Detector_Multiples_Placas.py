...
csv_writer.writerow(["timestamp", "plate_id", "event", "total_count", "location", "method", "notes"])
...
print(f"[INFO] Sesión finalizada. Total Placas: {len(counted_ids)}")
